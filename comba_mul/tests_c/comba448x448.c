...
void comba448x448(uint64_t *out, uint64_t *a, uint64_t *b) {
	...
	__uint128_t acc7 = CMB_MULL(a[6], b[1]) + CMB_MULL(a[5], b[2]) + CMB_MULL(a[4], b[3]) + CMB_MULL(a[3], b[4]) + CMB_MULL(a[2], b[5]) + CMB_MULL(a[1], b[6]) + CMB_MULH(a[6], b[0]) + CMB_MULH(a[5], b[1]) + CMB_MULH(a[4], b[2]) + CMB_MULH(a[3], b[3]) + CMB_MULH(a[2], b[4]) + CMB_MULH(a[1], b[5]) + CMB_MULH(a[0], b[6]);
	__uint128_t acc8 = CMB_MULL(a[6], b[2]) + CMB_MULL(a[5], b[3]) + CMB_MULL(a[4], b[4]) + CMB_MULL(a[3], b[5]) + CMB_MULL(a[2], b[6]) + CMB_MULH(a[6], b[1]) + CMB_MULH(a[5], b[2]) + CMB_MULH(a[4], b[3]) + CMB_MULH(a[3], b[4]) + CMB_MULH(a[2], b[5]) + CMB_MULH(a[1], b[6]);
	__uint128_t acc9 = CMB_MULL(a[6], b[3]) + CMB_MULL(a[5], b[4]) + CMB_MULL(a[4], b[5]) + CMB_MULL(a[3], b[6]) + CMB_MULH(a[6], b[2]) + CMB_MULH(a[5], b[3]) + CMB_MULH(a[4], b[4]) + CMB_MULH(a[3], b[5]) + CMB_MULH(a[2], b[6]);
	__uint128_t acc10 = CMB_MULL(a[6], b[4]) + CMB_MULL(a[5], b[5]) + CMB_MULL(a[4], b[6]) + CMB_MULH(a[6], b[3]) + CMB_MULH(a[5], b[4]) + CMB_MULH(a[4], b[5]) + CMB_MULH(a[3], b[6]);
	__uint128_t acc11 = CMB_MULL(a[6], b[5]) + CMB_MULL(a[5], b[6]) + CMB_MULH(a[6], b[4]) + CMB_MULH(a[5], b[5]) + CMB_MULH(a[4], b[6]);
	__uint128_t acc12 = CMB_MULL(a[6], b[6]) + CMB_MULH(a[6], b[5]) + CMB_MULH(a[5], b[6]);
	__uint128_t acc13 = CMB_MULH(a[6], b[6]);
