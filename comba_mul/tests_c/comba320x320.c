...
void comba320x320(uint64_t *out, uint64_t *a, uint64_t *b) {
	...
	__uint128_t acc5 = CMB_MULL(a[4], b[1]) + CMB_MULL(a[3], b[2]) + CMB_MULL(a[2], b[3]) + CMB_MULL(a[1], b[4]) + CMB_MULH(a[4], b[0]) + CMB_MULH(a[3], b[1]) + CMB_MULH(a[2], b[2]) + CMB_MULH(a[1], b[3]) + CMB_MULH(a[0], b[4]);
	__uint128_t acc6 = CMB_MULL(a[4], b[2]) + CMB_MULL(a[3], b[3]) + CMB_MULL(a[2], b[4]) + CMB_MULH(a[4], b[1]) + CMB_MULH(a[3], b[2]) + CMB_MULH(a[2], b[3]) + CMB_MULH(a[1], b[4]);
	__uint128_t acc7 = CMB_MULL(a[4], b[3]) + CMB_MULL(a[3], b[4]) + CMB_MULH(a[4], b[2]) + CMB_MULH(a[3], b[3]) + CMB_MULH(a[2], b[4]);
	__uint128_t acc8 = CMB_MULL(a[4], b[4]) + CMB_MULH(a[4], b[3]) + CMB_MULH(a[3], b[4]);
	__uint128_t acc9 = CMB_MULH(a[4], b[4]);
